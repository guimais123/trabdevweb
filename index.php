...
<body>
  ...
  <header class="masthead" style="background-image: url('img/background home img.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Geek Social</h1>
            <span class="subheading">O mundo dos games está aqui</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
          <a>
            <h2 class="post-title">
              Um sistema unico para amantes do mundo GEEK
            </h2>
            <h3 class="post-subtitle">
              Uma plataforma de integração do universo GEEK com o objetivo de aproximar as pessoas e aprofundar debates
            </h3>
          </a>
      </div>
    </div>
