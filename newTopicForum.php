  ...
  <div class="container">
    <div class="row">
      ...
      <?php
        ...
        ?>
        <form name="postForm" id="postForm" action="postCreater.php" method="POST">
          <label class="floating-label-form-group">Título do post</label>
          <input type="text" class="form-control"
          placeholder="Título" id="title" name="title">
          <label class="floating-label-form-group">Mensagem</label>
          <textarea type="longtext" class="form-control"
          placeholder="Mensagem" id="msg" name="msg"></textarea>
          <br>
          <button class="btn btn-primary" type="submit"
          id="loginButton">Publicar</button>
        </form>
      </div>
    </div>
  </div>
