...
<body>
  ...
  <header class="masthead" style="background-image: url('img/imgcadastro.jpeg')">
  ...
  <div class="container">
    <div class="row">
      ...
      <?php
        ...
        ?>
        <form name="LoginForm" id="contactForm" action="createProduto.php" method="POST">
          <label class="floating-label-form-group">Meu produto</label>
          <input type="text" class="form-control"
          placeholder="Insira o título" id="titulo" name="titulo">
